  ...
  return (
    <>
      ...
      <main className={"container " + styles.main}>
        ...
        <section id="light_container" className={"container gap-4 p-5 bg-light h-50 " + styles.full_width + ' ' + styles.align_to_top_el}>
          <div className={"container d-flex flex-column mt-5 " + styles.inner_contents}>
        ...
        <section id="features_container" className={"container d-flex flex-column gap-4 pt-5 mt-5"}>
          ...
          <section id="features_overflow" className="container row">
            <div className={"d-flex flex-row pt-5 m-auto gap-4"}>
