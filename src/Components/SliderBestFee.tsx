    ...
    return (
        <CardContent className={`d-flex flex-row row align-items-center justify-content-center col-6 `}>
            ...
            <Box className={'d-flex flex-column row my-2 text-center'}>
                ...
                <Box component={'div'} className='d-flex flex-row m-auto align-items-center mt-3'>
                    <Stack component={'div'} className={`d-flex flex-row row`}>
                        <img src={'/assets/images/concorrentes/Com bg/Botton_rates_hotmart.png'} alt="Hotmart" className={`d-flex flex-column col-4`} onClick={handleClick} style={{ cursor: 'pointer' }} />
                        <img src={'/assets/images/concorrentes/Com bg/Botton_rates_kiwify.png'} alt="Kiwify" className={`d-flex flex-column col-4`} onClick={handleClick} style={{ cursor: 'pointer' }} />
                        <img src={'/assets/images/concorrentes/Com bg/Botton_rates_ticto.png'} alt="Ticto" className={`d-flex flex-column col-4`} onClick={handleClick} style={{ cursor: 'pointer' }} />
                    </Stack>
                </Box>
